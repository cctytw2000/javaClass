...
public class TestjdbcConnDataSource implements DataSource {
	...
	public TestjdbcConnDataSource() throws IOException {
		this("mysqlserverjdbc.properties");
	}

	public TestjdbcConnDataSource(String config) throws IOException {
